...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050505] text-gray-500 py-12 md:py-20 border-t border-white/5">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4 text-xs font-light tracking-wider uppercase text-center md:text-left">
